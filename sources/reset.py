...
def set_save (savefile,dead=False, blank=True, scene=[0,0], tpt=None, player_pos=[0,0],map="main", choices=[0,0,0,0], genocide_ending_events=0, pacifist_ending_events=0, inventory={'money':0,'weapon':'no_weapon','heal_potions':0},hideout_passcode="jaimelecouscoustajine"):

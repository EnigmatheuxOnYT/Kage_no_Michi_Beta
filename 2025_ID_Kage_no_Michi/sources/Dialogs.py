...
class Dialogs(Cinematics):
    ...
    def dialog_minigm2(self, screen,saved):
        ...
        if saved == 'none':
            ...
            self.cinematic_frame(screen, "azw2", 2, "(Voyons voir..Ai-je quelque chose de plus urgent ?)", kind_info=[['SM','no_weapon'],['VL2','no_weapon'],1])
            output1, output2 = self.choice_frame(screen, "azw2", [0, 2], ["OUI", "NON"])
            if output1 == "choice":
                if output2==2:
            ...
            self.cinematic_frame(screen, "azw2", 3, "(Voyons voir..Ai-je quelque chose de plus urgent ?)", kind_info=[['SM','no_weapon'],['KM','no_weapon'],['VL2','no_weapon'],1])
            output1, output2 = self.choice_frame(screen, "azw2", [0, 2], ["OUI", "NON"])
            if output1 == "choice":
                if output2==2:
            ...
            if output1 == "choice":
                if output2==2:
                    ...
                    self.cinematic_frame(screen, "azw2", 3, "Je suis désolé monsieur. Il se trouve que je n'ai pas beaucoup de temps temps", "à ma disposition.", kind_info=[['SM','no_weapon'],['KT','no_weapon'],['VL2','no_weapon'],1])
        ...
        if saved == 'none':
            ...
            if output1 == "choice":
                if output2==2:
                    ...
                    self.cinematic_frame(screen, "azw2", 2, "L'honneur est pour moi madame. Je me suis contenté du nécessaire, c'est tout", "simplement du bon sens.", kind_info=[['VL3','no_weapon'],['SM','no_weapon'],2])
            ...
            if output1 == "choice":
                if output2==2:
                    ...
                    self.ecran_noir(screen)
                    self.cinematic_frame(screen, "azw2", 3, "Splendide ! Vous avez un très bon travail. Je vous félicite.", kind_info=[['SM','no_weapon'],['KM','no_weapon'],['VL3','no_weapon'],3])
                    self.cinematic_frame(screen, "azw2", 3, "L'honneur est pour moi madame. Je me suis contenté du nécessaire, c'est tout", "simplement du bon sens.",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'],['VL3', 'no_weapon'],1])
            ...
            if output1 == "choice":
                if output2==2:
                    ...
                    self.ecran_noir(screen)
                    self.cinematic_frame(screen, "azw2", 3, "Splendide ! Vous avez un très bon travail. Je vous félicite." , kind_info=[['SM','no_weapon'],['KT','no_weapon'],['VL3','no_weapon'],3])
    ...
    def dialog_infiltration(self,screen,saved,filature_reussie=True):
        ...
        if saved=='none':
            ...
            self.cinematic_frame(screen,"tkh1",2,"(Un code ? Qu'est-ce que ça peut bien être ?)",kind_info=[['SM','no_weapon'],['TW','no_weapon'],1,None,None,['TW']])
            if filature_reussie==True:
                self.cinematic_frame(screen, "tkh1", 2, "(Mais oui !)",kind_info=[['SM', 'no_weapon'], ['TW', 'no_weapon'], 1,None,None,['TW']])
                self.cinematic_frame(screen,"tkh1",2,"*dit le code* ",kind_info=[['SM','no_weapon'],['TW','no_weapon'],1,None,None,['TW']])
                self.cinematic_frame(screen,"tkh1",2,"Ok, entrez discrètement",kind_info=[['SM','no_weapon'],['TW','no_weapon'],2,None,None,['TW']])
                self.cinematic_frame(screen, "tkh1", 1, "Je le savais ! C'est bien le code que j'ai entendu !", kind_info=["SM","SM", "no_weapon","right"])
                self.cinematic_frame(screen, "tkh1", 1, "Cela signifie que cela doit être la sous-planque secrète du clan Takahiro !", kind_info=["SM","SM", "no_weapon","right"])
                self.cinematic_frame(screen, "tkh1", 1, "Bon, que faire  maintenant ? Est-ce que j'inflitre la base ou j'effectue des", "préparations ?", kind_info=["SM","SM", "no_weapon","right"])
            elif filature_reussie==False:
                self.cinematic_frame(screen, "tkh1", 2, "Hem… jaimelacouscoustajine ?",kind_info=[['SM', 'no_weapon'], ['TW', 'no_weapon'], 1,None,None,['TW']])
                self.cinematic_frame(screen,"tkh1",2,"Vas-t-en et laisse-nous tranquilles. Ne reviens pas si tu ne veux pas avoir", "des problèmes.",kind_info=[['SM','no_weapon'],['TW','no_weapon'],2,None,None,['TW']])
                self.cinematic_frame(screen, "tkh1", 1, "Mais pour qui il se prend, lui ?",kind_info=["SM","SM", "no_weapon","right"])
        elif saved=='KM':
            self.cinematic_frame(screen, "tkh1", 2,"Toc Toc", kind_info=[["SM",'no_weapon'],['KM','no_weapon'],1])
            self.cinematic_frame(screen,"tkh1",3,"Vous faites partie du clan ? Quel est le code ?",kind_info=[['SM','no_weapon'],['KM','no_weapon'],['TW','no_weapon'],3,None,['TW']])
            self.cinematic_frame(screen,"tkh1",3,"(Un code ? Qu'est-ce que ça peut bien être ?)",kind_info=[['SM','no_weapon'],['KM','no_weapon'],['TW','no_weapon'],1,None,['TW']])
            if filature_reussie==True:
                self.cinematic_frame(screen, "tkh1", 3, "(Mais oui !)",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['TW', 'no_weapon'], 1,None,['TW']])
                self.cinematic_frame(screen,"tkh1",3,"*dit le code* ",kind_info=[['SM','no_weapon'],['KM','no_weapon'], ['TW','no_weapon'],1,None,['TW']])
                self.cinematic_frame(screen,"tkh1",3,"Ok, entrez discrètement.",kind_info=[['SM','no_weapon'],['KM','no_weapon'],['TW','no_weapon'],3,None,['TW']])
                self.cinematic_frame(screen,"tkh1",2,"Je le savais ! C'est bien le code que j'ai entendu lorsque j'ai suivi les", "gardes !",kind_info=[['SM','no_weapon'],['KM','no_weapon'],1])
                ...
                self.cinematic_frame(screen, "tkh1", 3, "Hem… jaimelacouscoustajine ?",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['TW', 'no_weapon'], 1,None,['TW']])
                self.cinematic_frame(screen, "tkh1", 3, "Allez-vous-en et laissez-nous tranquilles. Ne revenez pas si vous ne voulez", "pas avoir des problèmes.",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['TW', 'no_weapon'],3,None,['TW']])
            ...
            self.cinematic_frame(screen, "tkh1", 2,"Toc Toc", kind_info=[["SM",'no_weapon'],['KT','no_weapon'],1])
            self.cinematic_frame(screen,"tkh1",3,"Vous faites partie du clan ? Quel est le code ?",kind_info=[['SM','no_weapon'],['KT','no_weapon'],['TW','no_weapon'],3,None,['TW']])
            self.cinematic_frame(screen,"tkh1",3,"(Un code ? Qu'est-ce que ça peut bien être ?)",kind_info=[['SM','no_weapon'],['KT','no_weapon'],['TW','no_weapon'],1,None,['TW']])
            if filature_reussie==True:
                self.cinematic_frame(screen, "tkh1", 3, "(Mais oui !)",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['TW', 'no_weapon'], 1,None,['TW']])
                self.cinematic_frame(screen,"tkh1",3,"*dit le code* ",kind_info=[['SM','no_weapon'],['KT','no_weapon'], ['TW','no_weapon'],1,None,['TW']])
                self.cinematic_frame(screen,"tkh1",3,"Ok, entrez discrètement",kind_info=[['SM','no_weapon'],['KT','no_weapon'],['TW','no_weapon'],3,None,['TW']])
                self.cinematic_frame(screen,"tkh1",2,"Je le savais ! C'est bien le code que j'ai entendu lorsque j'ai suivi les", "gardes !",kind_info=[['SM','no_weapon'],['KT','no_weapon'],1])
                ...
                self.cinematic_frame(screen, "tkh1", 3, "Hem… jaimelacouscoustajine ?",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['TW', 'no_weapon'], 1,None,['TW']])
                self.cinematic_frame(screen, "tkh1", 3, "Allez-vous-en et laissez-nous tranquilles. Ne revenez pas si vous ne voulez", "pas avoir des problèmes.",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['TW', 'no_weapon'], 3,None,['TW']])
...
if __name__ =="__main__":
    ...
    Dialogs().dialog_infiltration(screen,'none',True)
    pygame.quit()

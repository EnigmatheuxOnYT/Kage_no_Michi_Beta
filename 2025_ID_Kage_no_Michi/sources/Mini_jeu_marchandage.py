...
class minigm_trade:
    ...
    def intro(self, screen, saved):
        ...
        if saved=='none':
            ...
            self.cin.cinematic_frame(screen, 'bamboo2', 2, "100 pièces d'or ? C'est très cher !", "C'est l'argent que Sensei Hoshida m'a offert !", kind_info=[["SM","no_weapon"],["JM","no_weapon"], 1], running=self.running)
            self.cin.cinematic_frame(screen, 'bamboo2', 2, "Est-ce que je pourrai négocier avec son offre ? Ou existe-il une", "autre méthode ?", kind_info=[["SM","no_weapon"],["JM","no_weapon"], 1], running=self.running)
            self.cin.switch_lowercase(False)
            self.cin.cinematic_frame(screen, 'bamboo2', 2, "Votre arme m'a l'air fascinante. Avant cela, j'aimerai qu'on procède à", "des négociations.", kind_info=[["SM","no_weapon"],["JM","no_weapon"], 1], running=self.running)
            self.cin.cinematic_frame(screen, 'bamboo2', 2, "Des négociations ? Très bien. On les fera de ma manière.", kind_info=[["SM","no_weapon"],["JM","no_weapon"], 2], running=self.running)
            self.cin.cinematic_frame(screen, 'bamboo2', 2, "Tout d'abord, je vais prendre un total de 5 marchandises. Le but étant", "de deviner les prix de chacun.", kind_info=[["SM","no_weapon"],["JM","no_weapon"], 2], running=self.running)
            self.cin.cinematic_frame(screen, 'bamboo2', 2, "En fonction du nombre de bonnes réponses, je suis prêt à diminuer", "le coût de l'arme.", kind_info=[["SM","no_weapon"],["JM","no_weapon"], 2], running=self.running)
            self.cin.cinematic_frame(screen, 'bamboo2', 2, "Aucune objection ?", kind_info=[["SM","no_weapon"],["JM","no_weapon"], 2], running=self.running)
            self.cin.cinematic_frame(screen, 'bamboo2', 2, "Totalement ! Allons-y Marchand Juzo ! Débutons ces négociations.", kind_info=[["SM","no_weapon"],["JM","no_weapon"], 1], running=self.running)
        elif saved=='KM':
            self.cin.switch_lowercase(True)
            self.cin.cinematic_frame(screen, 'bamboo2', 3, "100 pièces d'or ? C'est très cher !", "C'est l'argent que Sensei Hoshida nous a offert !", kind_info=[["SM","no_weapon"],["KM","no_weapon"],["JM","no_weapon"], 1], running=self.running)
            self.cin.cinematic_frame(screen, 'bamboo2', 3, "Est-ce que je pourrai négocier avec son offre ?", "Ou existe-il une autre méthode ?", kind_info=[["SM","no_weapon"],["KM","no_weapon"],["JM","no_weapon"], 1], running=self.running)
            self.cin.switch_lowercase(False)
            self.cin.cinematic_frame(screen, 'bamboo2', 3, "Votre arme m'a l'air fascinante. Avant cela, j'aimerai qu'on procède à", "des négociations.", kind_info=[["SM","no_weapon"],["KM","no_weapon"],["JM","no_weapon"], 1], running=self.running)
            self.cin.cinematic_frame(screen, 'bamboo2', 3, "Des négociations ? Très bien. On les fera de ma manière.", kind_info=[["SM","no_weapon"],["KM","no_weapon"],["JM","no_weapon"], 3], running=self.running)
            self.cin.cinematic_frame(screen, 'bamboo2', 3, "Tout d'abord, je vais prendre un total de 5 marchandises. Le but étant", "de deviner les prix de chacun.", kind_info=[["SM","no_weapon"],["KM","no_weapon"],["JM","no_weapon"], 3], running=self.running)
            self.cin.cinematic_frame(screen, 'bamboo2', 3, "En fonction du nombre de bonnes réponses, je suis prêt à diminuer", "le coût de l'arme.", kind_info=[["SM","no_weapon"],["KM","no_weapon"],["JM","no_weapon"], 3], running=self.running)
            self.cin.cinematic_frame(screen, 'bamboo2', 3, "Aucune objection ?", kind_info=[["SM","no_weapon"],["KM","no_weapon"],["JM","no_weapon"], 3], running=self.running)
            self.cin.cinematic_frame(screen, 'bamboo2', 3, "C'est une très belle occasion grand frère. On pourra payer moins", "cher pour une arme aussi puissante !", kind_info=[["SM","no_weapon"],["KM","no_weapon"],["JM","no_weapon"], 2], running=self.running)
            self.cin.cinematic_frame(screen, 'bamboo2', 3, "Totalement ! Allons-y Marchand Juzo ! Débutons ces négociations.", kind_info=[["SM","no_weapon"],["KM","no_weapon"],["JM","no_weapon"], 1], running=self.running)
        elif saved=='KT':
            self.cin.switch_lowercase(True)
            self.cin.cinematic_frame(screen, 'bamboo2', 3, "100 pièces d'or ? C'est très cher !", "C'est l'argent que Sensei Hoshida nous a offert !", kind_info=[["SM","no_weapon"],["KT","no_weapon"],["JM","no_weapon"], 1], running=self.running)
            self.cin.cinematic_frame(screen, 'bamboo2', 3, "Est-ce que je pourrai négocier avec son offre ?", "Ou existe-il une autre méthode ?", kind_info=[["SM","no_weapon"],["KT","no_weapon"],["JM","no_weapon"], 1], running=self.running)
            self.cin.switch_lowercase(False)
            self.cin.cinematic_frame(screen, 'bamboo2', 3, "Ce “Tengoku no Ikari”... Je pense que tu devrais la prendre.", "Elle pourra nous être très utile dans le futur.", kind_info=[["SM","no_weapon"],["KT","no_weapon"],["JM","no_weapon"], 2], running=self.running)
            self.cin.cinematic_frame(screen, 'bamboo2', 3, "Votre arme m'a l'air fascinante. Avant cela, j'aimerai qu'on procède à", "des négociations.", kind_info=[["SM","no_weapon"],["KT","no_weapon"],["JM","no_weapon"], 1], running=self.running)
            self.cin.cinematic_frame(screen, 'bamboo2', 3, "Des négociations ? Très bien. On les fera de ma manière.", kind_info=[["SM","no_weapon"],["KT","no_weapon"],["JM","no_weapon"], 3], running=self.running)
            self.cin.cinematic_frame(screen, 'bamboo2', 3, "Tout d'abord, je vais prendre un total de 5 marchandises. Le but étant", "de deviner les prix de chacun.", kind_info=[["SM","no_weapon"],["KT","no_weapon"],["JM","no_weapon"], 3], running=self.running)
            self.cin.cinematic_frame(screen, 'bamboo2', 3, "En fonction du nombre de bonnes réponses, je suis prêt à diminuer", "le coût de l'arme.", kind_info=[["SM","no_weapon"],["KT","no_weapon"],["JM","no_weapon"], 3], running=self.running)
            self.cin.cinematic_frame(screen, 'bamboo2', 3, "Aucune objection ?", kind_info=[["SM","no_weapon"],["KT","no_weapon"],["JM","no_weapon"], 3], running=self.running)
            self.cin.cinematic_frame(screen, 'bamboo2', 3, "Totalement ! Allons-y Marchand Juzo ! Débutons ces négociations.", kind_info=[["SM","no_weapon"],["KT","no_weapon"],["JM","no_weapon"], 1], running=self.running)
        self.in_minigm = True
    ...
    def end(self, screen, saved):
        if self.compteur_de_point >= 3:
            if saved == 'none':
                self.cin.cinematic_frame(screen, 'bamboo2', 2, "Bravo. Vous vous êtes bien débrouillé. Désormais, que ferez-vous?", kind_info=[["SM","no_weapon"],["JM","no_weapon"], 2], running=self.running)
                self.cin.cinematic_frame(screen, 'bamboo2', 2, "(Je dois maintenant décider d'acheter ou non l'arme...)", kind_info=[["SM","no_weapon"],["JM","no_weapon"], 1], running=self.running)
            elif saved == 'KM':
                self.cin.cinematic_frame(screen, 'bamboo2', 3, "Bravo. Vous vous êtes bien débrouillé. Désormais, que ferez-vous?", kind_info=[["SM","no_weapon"],["KM","no_weapon"],["JM","no_weapon"], 3], running=self.running)
                self.cin.cinematic_frame(screen, 'bamboo2', 3, "(On devrait peut-être discuter avant de prendre une décision...)", kind_info=[["SM","no_weapon"],["KM","no_weapon"],["JM","no_weapon"], 2], running=self.running)
            elif saved == 'KT':
                self.cin.cinematic_frame(screen, 'bamboo2', 3, "Bravo. Vous vous êtes bien débrouillé. Désormais, que ferez-vous?", kind_info=[["SM","no_weapon"],["KT","no_weapon"],["JM","no_weapon"], 3], running=self.running)
                self.cin.cinematic_frame(screen, 'bamboo2', 3, "(Cette arme pourrait être cruciale pour notre mission...)", kind_info=[["SM","no_weapon"],["KT","no_weapon"],["JM","no_weapon"], 2], running=self.running)
        else:
            self.cin.cinematic_frame(screen, 'bamboo2', 2, "Hmm… Pas terrible. Vous auriez pu mieux faire. Mais bon, les affaires", "sont les affaires. Alors, que décidez-vous ?", kind_info=[["SM","no_weapon"], [saved,'no_weapon'],["JM","no_weapon"], 3], running=self.running)

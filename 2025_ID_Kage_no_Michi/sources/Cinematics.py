...
class Cinematics:
    ...
    def choice_frame (self,screen:pygame.surface.Surface,bg:str,kind:list=[0,4],choices:List[str]=["","","",""],chars:List[List[str]]=[],timer:int=0)-> List[Union[str,int]] :
        ...
        button_light_surface = pygame.image.load("../data/assets/buttons/Fond_Bouton_VERT_200p.png")
        button_dark_surface = pygame.image.load("../data/assets/buttons/Fond_Bouton_VERTF_200p.png")

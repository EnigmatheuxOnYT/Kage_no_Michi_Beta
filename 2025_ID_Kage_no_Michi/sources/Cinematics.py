...
class Cinematics:
    ...
    def cinematic_11 (self, screen, saved="none", choose=1):
        ...
        if saved == 'none':
            ...
            if choose == 1:
                ...
                self.cinematic_frame(screen, 'bamboo1', 3, "Continuons de rester sur nos gardes. On ne sait jamais.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 2])
                ...
                self.cinematic_frame(screen, 'bamboo1', 3, "Oui, au revoir marchand Juzo !",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'bamboo1', 0,"Musashi poursuit son voyage pour venger son village natal. Arrivera-t-il","à atteindre sa destination? A suivre dans le prochain épisode.")
            elif choose ==4:
    ...
    def cinematic_14(self,screen,saved):
        ...
        if saved =='none':
            ...
            self.cinematic_frame(screen, "mgm8", 2, "!!!",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], 1])
            ...
            self.cinematic_frame(screen, "mgm8", 2, "!!!",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], 1])
    ...
    def cinematic_15(self,screen,saved,juzo,in_genocide_route):
        ...
        if saved =='none':
            ...
            if in_genocide_route==True:
                self.cinematic_frame(screen, 'bamboo3', 2, "..Musashi.", kind_info=[['SM','no_weapon'], ['SH','no_weapon'], 2])
                self.cinematic_frame(screen, 'bamboo3', 2, "Sensei Hoshida ? Que faîtes vous ici ?", kind_info=[['SM','no_weapon'], ['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 2, "Tu sais très bien pourquoi je suis ici.", kind_info=[['SM','no_weapon'], ['SH','no_weapon'], 2])
                self.cinematic_frame(screen, 'bamboo3', 2, "? ? ? Je n'ai pas la moindre idée de votre présence.", kind_info=[['SM','no_weapon'], ['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 2, "Dans ce cas là..J'aimerai bien que tu m'expliques..", kind_info=[['SM','no_weapon'], ['SH','no_weapon'], 2])
                self.cinematic_frame(screen, 'bamboo3', 2, "La présence de sang qui couvre tes vêtements..", kind_info=[['SM','no_weapon'], ['SH','no_weapon'], 2])
                self.cinematic_frame(screen, 'bamboo3', 2, "Du sang ? Pff, franchement c'est juste le sang de certains membres du clan", "Takahiro.", kind_info=[['SM','no_weapon'], ['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 2, "Ne vous inquiétez pas, c'est pour le bien de chacun.", kind_info=[['SM','no_weapon'], ['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 2, "S'ils ont tué, je ne devrais pas pour autant me restreindre à me défendre pour", "les tuer aussi.", kind_info=[['SM','no_weapon'], ['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 2, "C'est justement le problème Musashi. Tu ne fais que de tuer.", kind_info=[['SM','no_weapon'], ['SH','no_weapon'], 2])
                self.cinematic_frame(screen, 'bamboo3', 2, "Si tu poursuis ce chemin, tu vas fortement le regretter. ", kind_info=[['SM','no_weapon'], ['SH','no_weapon'], 2])
                self.cinematic_frame(screen, 'bamboo3', 2, "Tu vas t'apercevoir au final que tu seras devenu ce que tu détestais", "auparavant.", kind_info=[['SM','no_weapon'], ['SH','no_weapon'], 2])
                self.cinematic_frame(screen, 'bamboo3', 2, "La raison pour laquelle je bloque ton passage, c'est de te faire comprendre", "cela.", kind_info=[['SM','no_weapon'], ['SH','no_weapon'], 2])
                self.cinematic_frame(screen, 'bamboo3', 2, "Et pourtant, tu aurais dit la même chose à ces tueurs non ?", kind_info=[['SM','no_weapon'], ['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 2, "Si la violence est le seul moyen de faire changer le monde à ta guise, alors", "j'en ferai bon usage.", kind_info=[['SM','no_weapon'], ['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 2, "Pas forcément Musashi, pas forcément. ", kind_info=[['SM','no_weapon'], ['SH','no_weapon'], 2])
                self.cinematic_frame(screen, 'bamboo3', 2, "Prendre une décision pacifiste est l'une des meilleures décisions qu'on puisse", "prendre moralement.", kind_info=[['SM','no_weapon'], ['SH','no_weapon'], 2])
                self.cinematic_frame(screen, 'bamboo3', 2, "Le but d'être pacifiste, c'est de faire comprendre aux autres de ne pas avoir", "toujours recours à la violence.", kind_info=[['SM','no_weapon'], ['SH','no_weapon'], 2])
                self.cinematic_frame(screen, 'bamboo3', 2, "Donc Musashi...Mon cher élève..Quel chemin vas-tu prendre ?", kind_info=[['SM','no_weapon'], ['SH','no_weapon'], 2])
                self.cinematic_frame(screen, 'bamboo3', 2, "Le chemin des regrets ? Ou le chemin du succès ?", kind_info=[['SM','no_weapon'], ['SH','no_weapon'], 2])
                output1, output2 = self.choice_frame(screen, "bamboo3", [0, 2], ["ECOUTER SENSEI", "NE PAS L'ECOUTER"])
                if output1=='choice':
                    if output2==1:
                        self.cinematic_frame(screen, "bamboo3", 2, "..Oui vous avez certainement raison Sensei Hoshida.",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 2, "J'ai été beaucoup aveuglé par la violence. Je ne faisais que d'en vouloir au", "clan Takahiro.",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 2, "J'avais un très grand désir de vengeance..Mais je souhaite me repentir.",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 2, "Même si on a accumulé des regrets jusqu'ici, alors je suis prêt à accumuler", "des succès à partir d'aujourd'hui.",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 2, "Je suis fier de toi, mon cher élève. Poursuis le chemin de rédemption, et", "deviens un véritable samouraï.",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 2])
                        self.cinematic_frame(screen, "bamboo3", 2, "Cesse les massacres, laisse ton esprit se ressaisir et tu t'offriras une", "meilleure voie.",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 2])
                        self.cinematic_frame(screen, "bamboo3", 2, "Oui Sensei Hoshida. Veuillez me pardonner de tout ce qu'ai pu faire d'atroce.",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 2, "Tant que tu gardes ta parole, alors je suis prêt à te pardonner Musashi.",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 2])
                        self.cinematic_frame(screen, "bamboo3", 2, "La fin du voyage approche, alors je t'en prie, viens à bout du clan Takahiro,", "pour tout le Japon.",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 2])
                        self.cinematic_frame(screen, "bamboo3", 2, "Oui Sensei Hoshida, je ne compte pas vous décevoir ! ",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 0, "Musashi s'approche de plus en plus à son plus grand affrontement.")
                        self.cinematic_frame(screen, "bamboo3", 0, "Le chef du clan Takahiro, l'attend dans son domaine avec impatience, pour","pouvoir en finir.")
                        self.cinematic_frame(screen, "bamboo3", 0, "Qui en sortira vainqueur ? A suivre dans le prochain épisode..")

                    elif output2==2:
                        self.cinematic_frame(screen, "bamboo3", 2, "...",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 2, "Alors Musashi ? Ta décision ?",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 2])
                        self.cinematic_frame(screen, "bamboo3", 2, "Eh bien Sensei Hoshida, je pense que vous connaissez déjà la réponse.",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 2, "Ah ! Tu me rassures alors Musashi. Je suis fier de ton choi-",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 0, "(SCHIOU) (Sensei Hoshida se fait transpercer le coeur par Musashi)")
                        self.cinematic_frame(screen, "bamboo3", 2, "!!!Guah..",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 2])
                        self.cinematic_frame(screen, "bamboo3", 2, "Mais...Pourquoi...Fais...Tu...Cela…",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 2])
                        self.cinematic_frame(screen, "bamboo3", 2, "Heh, vieux schnock. Tu n'as pas du tout compris on dirait.",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 2, "Comme je l'ai déjà dit, la violence est l'outil le plus pratique pour pouvoir", "faire changer le monde à sa guise.",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 2, "Sans la violence, on cesse d'évoluer. C'est grâce aux combats, aux duels,", "guerres qu'on n'arrive à avoir dans de nouvelles avancées technologiques.",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 2, "Vous vous trompez fortement sur la distinction de ces deux chemins.",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 2, "..Tu me déçois fortement mon cher élève..",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 2])
                        self.cinematic_frame(screen, "bamboo3", 2, "Je vous retourne le compliment. Je vais tous les massacrer, vous verrez..",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 2, "..Tu.. es.. renvoyé..",kind_info=[['SM', 'no_weapon'], ['SH', 'no_weapon'], 2])
                        self.cinematic_frame(screen, "bamboo3", 0, "(Sensei Hoshida tombe par terre)")
                        self.cinematic_frame(screen, "bamboo3", 1, "Hmph. Il n'en avait pas pour longtemps ce vieillard.",kind_info=['SM','SM', 'no_weapon','right'])
                        self.cinematic_frame(screen, "bamboo3", 0, "Musashi s'approche de plus en plus de son plus grand affrontement.")
                        self.cinematic_frame(screen, "bamboo3", 0, "Le chef du clan Takahiro, l'attend dans son domaine avec impatience, pour", "pouvoir en finir.")
                        self.cinematic_frame(screen, "bamboo3", 0, "Qui en sortira vainqueur ? A suivre dans le prochain épisode..")
        elif saved =='KM':
            if juzo==True:
                ...
                self.cinematic_frame(screen, "bamboo5", 3, "Musashi ! C'est urgent ! !",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'],3])
                self.cinematic_frame(screen, "bamboo5", 3, "C'est marchand Juzo !",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'],2])
                self.cinematic_frame(screen, "bamboo5", 3, "Quoi donc ?",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'],1])
                ...
                self.cinematic_frame(screen, "bamboo5", 3, "Quoi ?! Vous avez donné une arme maudite à mon frère ?!!",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'],2])
                self.cinematic_frame(screen, "bamboo5", 3, "Alors que c'est l'une des 7 épées légendaires ?",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'],1])
                ...
                self.cinematic_frame(screen, "bamboo5", 3, "Musashi, es-tu sûr de toi ??",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'],2])
                self.cinematic_frame(screen, "bamboo5", 3, "Merci de t'inquiéter Keiko.",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'],1])
            ...
            if in_genocide_route==True:
                self.cinematic_frame(screen, 'bamboo3', 3, "..Musashi.", kind_info=[['SM','no_weapon'], ['KM','no_weapon'], ['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "Sensei Hoshida ? Que faîtes vous ici ?", kind_info=[['SM','no_weapon'], ['KM','no_weapon'],['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 3, "Tu sais très bien pourquoi je suis ici.", kind_info=[['SM','no_weapon'],['KM','no_weapon'], ['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "? ? ? Je n'ai pas la moindre idée de votre présence.", kind_info=[['SM','no_weapon'],['KM','no_weapon'], ['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 3, "Dans ce cas là..J'aimerai bien que tu m'expliques..", kind_info=[['SM','no_weapon'],['KM','no_weapon'], ['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "La présence de sang qui couvre tes vêtements..", kind_info=[['SM','no_weapon'],['KM','no_weapon'], ['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "Du sang ? Pff, franchement c'est juste le sang de certains membres du", "clan Takahiro.", kind_info=[['SM','no_weapon'],['KM','no_weapon'], ['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 3, "Ne vous inquiétez pas, c'est pour le bien de chacun.", kind_info=[['SM','no_weapon'],['KM','no_weapon'], ['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 3, "S'ils ont tué, je ne devrais pas pour autant me restreindre à me défendre pour", "les tuer aussi.", kind_info=[['SM','no_weapon'],['KM','no_weapon'], ['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 3, "Musashi... ne dis quand même pas cela..", kind_info=[['SM','no_weapon'],['KM','no_weapon'], ['SH','no_weapon'], 2])
                self.cinematic_frame(screen, 'bamboo3', 3, "C'est justement le problème Musashi. Tu ne fais que de tuer.", kind_info=[['SM','no_weapon'], ['KM','no_weapon'],['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "Si tu poursuis ce chemin, tu vas fortement le regretter. ", kind_info=[['SM','no_weapon'], ['KM','no_weapon'],['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "Tu vas t'apercevoir au final que tu seras devenu ce que tu détestais", "auparavant.", kind_info=[['SM','no_weapon'],['KM','no_weapon'], ['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "La raison pour laquelle je bloque ton passage, c'est de te faire comprendre", "cela.", kind_info=[['SM','no_weapon'],['KM','no_weapon'], ['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "Et pourtant, tu aurais dit la même chose à ces tueurs non ?", kind_info=[['SM','no_weapon'],['KM','no_weapon'], ['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 3, "Si la violence est le seul moyen de faire changer le monde à ta guise, alors", "j'en ferai bon usage.", kind_info=[['SM','no_weapon'],['KM','no_weapon'], ['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 3, "Pas forcément Musashi, pas forcément. ", kind_info=[['SM','no_weapon'],['KM','no_weapon'], ['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "Prendre une décision pacifiste est l'une des meilleures décisions qu'on puisse", "prendre moralement.", kind_info=[['SM','no_weapon'],['KM','no_weapon'], ['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "Le but d'être pacifiste, c'est de faire comprendre aux autres de ne pas avoir", "toujours recours à la violence.", kind_info=[['SM','no_weapon'], ['KM','no_weapon'],['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "Donc Musashi...Mon cher élève..Quel chemin vas-tu prendre ?", kind_info=[['SM','no_weapon'], ['KM','no_weapon'],['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "Le chemin des regrets ? Ou le chemin du succès ?", kind_info=[['SM','no_weapon'],['KM','no_weapon'], ['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "Musashi, je t'en supplie. Ecoute ton sensei !", kind_info=[['SM','no_weapon'],['KM','no_weapon'], ['SH','no_weapon'], 2])
                output1, output2 = self.choice_frame(screen, "bamboo3", [0, 2], ["ECOUTER SENSEI", "NE PAS L'ECOUTER"])
                if output1=='choice':
                    if output2==1:
                        self.cinematic_frame(screen, "bamboo3", 3, "..Oui vous avez certainement raison Sensei Hoshida.",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "J'ai été beaucoup aveuglé par la violence. Je ne faisais que d'en vouloir au", "clan Takahiro.",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "J'avais un très grand désir de vengeance..Mais je souhaite me repentir.",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "Même si on a accumulé des regrets jusqu'ici, alors je suis prêt à accumuler", "des succès à partir d'aujourd'hui.",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "Je suis fier de toi, mon cher élève.  Poursuis le chemin de rédemption, et", "deviens un véritable samouraï.",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 3])
                        self.cinematic_frame(screen, "bamboo3", 3, "Cesse les massacres, laisse ton esprit se ressaisir et tu t'offriras une", "meilleure voie.",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 3])
                        self.cinematic_frame(screen, "bamboo3", 3, "Oui Sensei Hoshida. Veuillez me pardonner de tout ce qu'ai pu faire d'atroce.",kind_info=[['SM', 'no_weapon'], ['KM','no_weapon'],['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "Tant que tu gardes ta parole, alors je suis prêt à te pardonner Musashi.",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 3])
                        self.cinematic_frame(screen, 'bamboo3', 3, "Tu es enfin redevenu toi-même Musashi !!",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['SH', 'no_weapon'],2])
                        self.cinematic_frame(screen, "bamboo3", 3, "La fin du voyage approche, alors je t'en prie, viens à bout du clan Takahiro,", "pour tout le Japon.",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 3])
                        self.cinematic_frame(screen, "bamboo3", 3, "Oui Sensei Hoshida, je ne compte pas vous décevoir ! ",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 0, "Musashi s'approche de plus en plus à son plus grand affrontement.")
                        self.cinematic_frame(screen, "bamboo3", 0, "Le chef du clan Takahiro, l'attend dans son domaine avec impatience, pour","pouvoir en finir.")
                        self.cinematic_frame(screen, "bamboo3", 0, "Qui en sortira vainqueur ? A suivre dans le prochain épisode..")

                    elif output2==2:
                        self.cinematic_frame(screen, "bamboo3", 3, "...",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "Alors Musashi ? Ta décision ?",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 3])
                        self.cinematic_frame(screen, "bamboo3", 3, "Eh bien Sensei Hoshida, je pense que vous connaissez déjà la réponse.",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "Ah ! Tu me rassures alors Musashi. Je suis fier de ton choi-",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 0, "(SCHIOU) (Sensei Hoshida se fait transpercer le coeur par Musashi)")
                        self.cinematic_frame(screen, "bamboo3", 3, "!!!Guah..",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 3])
                        self.cinematic_frame(screen, "bamboo3", 3, "Mais...Pourquoi...Fais...Tu...Cela…",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 3])
                        self.cinematic_frame(screen, 'bamboo3', 3, "Mais, tu es devenu totalement fou Musashi !!!",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['SH', 'no_weapon'],2])
                        self.cinematic_frame(screen, "bamboo3", 3, "Heh, vieux schnock. Tu n'as pas du tout compris on dirait.",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "Comme je l'ai déjà dit, la violence est l'outil le plus pratique pour pouvoir", "faire changer le monde à sa guise.",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "Sans la violence, on cesse d'évoluer. C'est grâce aux combats, aux duels,", "guerres qu'on n'arrive à avoir dans de nouvelles avancées technologiques.",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "Vous vous trompez fortement sur la distinction de ces deux chemins.",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "..Tu me déçois fortement mon cher élève..",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 3])
                        self.cinematic_frame(screen, "bamboo3", 3, "Je vous retourne le compliment. Je vais tous les massacrer, vous verrez..",kind_info=[['SM', 'no_weapon'], ['KM','no_weapon'],['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "..Tu.. es.. renvoyé..",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'], ['SH', 'no_weapon'], 3])
                        self.cinematic_frame(screen, "bamboo3", 0, "(Sensei Hoshida tombe par terre)")
                        self.cinematic_frame(screen, 'bamboo3', 2, "Je ne te reconnais plus, je ne reconnais plus mon grand-frère Musashi...", "Qu'es-tu devenu... ",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'],2])
                        self.cinematic_frame(screen, "bamboo3", 2, "Hmph. Il n'en avait pas pour longtemps ce vieillard.",kind_info=[['SM', 'no_weapon'],['KM','no_weapon'],1])
                        self.cinematic_frame(screen, "bamboo3", 0, "Musashi s'approche de plus en plus de son plus grand affrontement.")
                        self.cinematic_frame(screen, "bamboo3", 0, "Le chef du clan Takahiro, l'attend dans son domaine avec impatience, pour", "pouvoir en finir.")
                        self.cinematic_frame(screen, "bamboo3", 0, "Qui en sortira vainqueur ? A suivre dans le prochain épisode..")
            ...
            if juzo==True:
                ...
                self.cinematic_frame(screen, "bamboo5", 3, "Musashi ! C'est urgent ! !",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'],3])
                self.cinematic_frame(screen, "bamboo5", 3, "C'est marchand Juzo !",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'],2])
                self.cinematic_frame(screen, "bamboo5", 3, "Quoi donc ?",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'],1])
                ...
                self.cinematic_frame(screen, "bamboo5", 3, "!! Une arme maudite ?",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'],2])
                self.cinematic_frame(screen, "bamboo5", 3, "Alors que c'est l'une des 7 épées légendaires ?",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'],1])
                ...
                self.cinematic_frame(screen, "bamboo5", 3, "Musashi, je vais t'aider dans ton duel.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'],2])
                self.cinematic_frame(screen, "bamboo5", 3, "Je te remercie Takeshi, mais puisque c'est un duel, ce n'est qu'entre mon", "adversaire et moi.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'],1])
            ...
            if in_genocide_route==True:
                self.cinematic_frame(screen, 'bamboo3', 3, "..Musashi.", kind_info=[['SM','no_weapon'], ['KT','no_weapon'], ['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "Sensei Hoshida ? Que faîtes vous ici ?", kind_info=[['SM','no_weapon'], ['KT','no_weapon'],['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 3, "Tu sais très bien pourquoi je suis ici.", kind_info=[['SM','no_weapon'],['KT','no_weapon'], ['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "? ? ? Je n'ai pas la moindre idée de votre présence.", kind_info=[['SM','no_weapon'],['KT','no_weapon'], ['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 3, "Dans ce cas là..J'aimerai bien que tu m'expliques..", kind_info=[['SM','no_weapon'],['KT','no_weapon'], ['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "La présence de sang qui couvre tes vêtements..", kind_info=[['SM','no_weapon'],['KT','no_weapon'], ['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "Du sang ? Pff, franchement c'est juste le sang de certains membres du", "clan Takahiro.", kind_info=[['SM','no_weapon'],['KT','no_weapon'], ['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 3, "Ne vous inquiétez pas, c'est pour le bien de chacun.", kind_info=[['SM','no_weapon'],['KT','no_weapon'], ['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 3, "S'ils ont tué, je ne devrais pas pour autant me restreindre à me défendre pour", "les tuer aussi.", kind_info=[['SM','no_weapon'],['KT','no_weapon'], ['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 3, "Musashi... ne dis quand même pas ça", kind_info=[['SM','no_weapon'],['KT','no_weapon'], ['SH','no_weapon'], 2])
                self.cinematic_frame(screen, 'bamboo3', 3, "C'est justement le problème Musashi. Tu ne fais que de tuer.", kind_info=[['SM','no_weapon'], ['KT','no_weapon'],['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "Si tu poursuis ce chemin, tu vas fortement le regretter. ", kind_info=[['SM','no_weapon'], ['KT','no_weapon'],['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "Tu vas t'apercevoir au final que tu seras devenu ce que tu détestais", "auparavant.", kind_info=[['SM','no_weapon'],['KT','no_weapon'], ['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "La raison pour laquelle je bloque ton passage, c'est de te faire comprendre", "cela.", kind_info=[['SM','no_weapon'],['KT','no_weapon'], ['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "Et pourtant, tu aurais dit la même chose à ces tueurs non ?", kind_info=[['SM','no_weapon'],['KT','no_weapon'], ['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 3, "Si la violence est le seul moyen de faire changer le monde à ta guise, alors", "j'en ferai bon usage.", kind_info=[['SM','no_weapon'],['KT','no_weapon'], ['SH','no_weapon'], 1])
                self.cinematic_frame(screen, 'bamboo3', 3, "Pas forcément Musashi, pas forcément. ", kind_info=[['SM','no_weapon'],['KT','no_weapon'], ['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "Prendre une décision pacifiste est l'une des meilleures décisions qu'on puisse", "prendre moralement.", kind_info=[['SM','no_weapon'],['KT','no_weapon'], ['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "Le but d'être pacifiste, c'est de faire comprendre aux autres de ne pas avoir", "toujours recours à la violence.", kind_info=[['SM','no_weapon'], ['KT','no_weapon'],['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "Donc Musashi...Mon cher élève..Quel chemin vas-tu prendre ?", kind_info=[['SM','no_weapon'], ['KT','no_weapon'],['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "Le chemin des regrets ? Ou le chemin du succès ?", kind_info=[['SM','no_weapon'],['KT','no_weapon'], ['SH','no_weapon'], 3])
                self.cinematic_frame(screen, 'bamboo3', 3, "Musashi, je t'en supplie. Ecoute notre sensei !", kind_info=[['SM','no_weapon'],['KT','no_weapon'], ['SH','no_weapon'], 2])
                output1, output2 = self.choice_frame(screen, "bamboo3", [0, 2], ["ECOUTER SENSEI", "NE PAS L'ECOUTER"])
                if output1=='choice':
                    if output2==1:
                        self.cinematic_frame(screen, "bamboo3", 3, "..Oui vous avez certainement raison Sensei Hoshida.",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "J'ai été beaucoup aveuglé par la violence. Je ne faisais que d'en vouloir au", "clan Takahiro.",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "J'avais un très grand désir de vengeance..Mais je souhaite me repentir.",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "Même si on a accumulé des regrets jusqu'ici, alors je suis prêt à accumuler", "des succès à partir d'aujourd'hui.",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "Je suis fier de toi, mon cher élève.  Poursuis le chemin de rédemption, et", "deviens un véritable samouraï.",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 3])
                        self.cinematic_frame(screen, "bamboo3", 3, "Cesse les massacres, laisse ton esprit se ressaisir et tu t'offriras une", "meilleure voie.",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 3])
                        self.cinematic_frame(screen, "bamboo3", 3, "Oui Sensei Hoshida. Veuillez me pardonner de tout ce qu'ai pu faire d'atroce.",kind_info=[['SM', 'no_weapon'], ['KT','no_weapon'],['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "Tant que tu gardes ta parole, alors je suis prêt à te pardonner Musashi.",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 3])
                        self.cinematic_frame(screen, 'bamboo3', 3, "Tu es enfin redevenu toi-même Musashi !!",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['SH', 'no_weapon'],2])
                        self.cinematic_frame(screen, "bamboo3", 3, "La fin du voyage approche, alors je t'en prie, viens à bout du clan Takahiro,", "pour tout le Japon.",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 3])
                        self.cinematic_frame(screen, "bamboo3", 3, "Oui Sensei Hoshida, je ne compte pas vous décevoir ! ",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 0, "Musashi s'approche de plus en plus à son plus grand affrontement.")
                        self.cinematic_frame(screen, "bamboo3", 0, "Le chef du clan Takahiro, l'attend dans son domaine avec impatience, pour","pouvoir en finir.")
                        self.cinematic_frame(screen, "bamboo3", 0, "Qui en sortira vainqueur ? A suivre dans le prochain épisode..")

                    elif output2==2:
                        self.cinematic_frame(screen, "bamboo3", 3, "...",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "Alors Musashi ? Ta décision ?",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 3])
                        self.cinematic_frame(screen, "bamboo3", 3, "Eh bien Sensei Hoshida, je pense que vous connaissez déjà la réponse.",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "Ah ! Tu me rassures alors Musashi. Je suis fier de ton choi-",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 0, "(SCHIOU) (Sensei Hoshida se fait transpercer le coeur par Musashi)")
                        self.cinematic_frame(screen, "bamboo3", 3, "!!!Guah..",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 3])
                        self.cinematic_frame(screen, "bamboo3", 3, "Mais...Pourquoi...Fais...Tu...Cela…",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 3])
                        self.cinematic_frame(screen, 'bamboo3', 3, "Mais, tu es devenu totalement fou Musashi !!!",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['SH', 'no_weapon'],2])
                        self.cinematic_frame(screen, "bamboo3", 3, "Heh, vieux schnock. Tu n'as pas du tout compris on dirait.",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "Comme je l'ai déjà dit, la violence est l'outil le plus pratique pour pouvoir", "faire changer le monde à sa guise.",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "Sans la violence, on cesse d'évoluer. C'est grâce aux combats, aux duels,", "guerres qu'on n'arrive à avoir dans de nouvelles avancées technologiques.",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "Vous vous trompez fortement sur la distinction de ces deux chemins.",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "..Tu me déçois fortement mon cher élève..",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 3])
                        self.cinematic_frame(screen, "bamboo3", 3, "Je vous retourne le compliment. Je vais tous les massacrer, vous verrez..",kind_info=[['SM', 'no_weapon'], ['KT','no_weapon'],['SH', 'no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 3, "..Tu.. es.. renvoyé..",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], ['SH', 'no_weapon'], 3])
                        self.cinematic_frame(screen, "bamboo3", 0, "(Sensei Hoshida tombe par terre)")
                        self.cinematic_frame(screen, 'bamboo3', 2, "Je ne te reconnais plus, je ne reconnais plus mon ami Musashi...", "Qu'es-tu devenu... ",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'],2])
                        self.cinematic_frame(screen, "bamboo3", 2, "Hmph. Il n'en avait pas pour longtemps ce vieillard.",kind_info=[['SM', 'no_weapon'],['KT','no_weapon'], 1])
                        self.cinematic_frame(screen, "bamboo3", 0, "Musashi s'approche de plus en plus de son plus grand affrontement.")
                        self.cinematic_frame(screen, "bamboo3", 0, "Le chef du clan Takahiro, l'attend dans son domaine avec impatience, pour", "pouvoir en finir.")
                        self.cinematic_frame(screen, "bamboo3", 0, "Qui en sortira vainqueur ? A suivre dans le prochain épisode..")
    ...
    def cinematic_16(self,screen,saved):
        #cinématique vérifiée
        if saved=='none':
            self.cinematic_frame(screen, "tkh2",0,"Le combat tant attendu est arrivé.")
            self.cinematic_frame(screen, "tkh2",0,"Musashi avec son visage coriace reprend sa respiration avant la bataille", "finale.")
            self.cinematic_frame(screen, "tkh2",0,"Ces deux destins s'entrechoqueront très bientôt.")
            self.cinematic_frame(screen, "tkh2",0,"Un loup blanc solitaire...contre une armée de chasseurs impitoyables..")
            self.cinematic_frame(screen, "tkh2",0,"Saurez-vous guider vos compétences vers la victoire?")
            self.cinematic_frame(screen, "tkh2",0,"Nous le saurons...dès maintenant.")
            self.ecran_noir(screen)
    ...
    def cinematic_20(self,screen,route):
        ...
        if route=='pacifist':
            ...
            self.cinematic_frame(screen, "tkh1", 2, "Même si on regrette d'avoir commis de tels actes, de telles erreurs, de telles", "pêchés..On a toujours l'opportunité de changer..",kind_info=[['SM', 'no_weapon'], ['TK', 'no_weapon'], 1])
            ...
            self.cinematic_frame(screen, "tkh1", 2, "Tch.Décidément..tu..n'es..vraiment..qu'un..véritable..prétentieux..",kind_info=[['SM', 'no_weapon'], ['TK', 'no_weapon'], 2])
...
if __name__ == '__main__':
    ...
    c = Cinematics()
    output = c.cinematic_20(screen,"genocide")
    print(output)
    pygame.quit()

...
class Cinematics:
    ...
    def cinematic_10(self, screen, saved="none"):
        if saved == 'none':
            ...
            self.cinematic_frame(screen, 'azw1', 2, "C'est vrai. Veuillez m'excuser de mon impolitesse. Je suis Shikisha Musashi.", "Je viens du village de Magome, et je suis récemment devenu un samouraï.","Enchanté. Et vous ?", kind_info=[['SM','no_weapon'], ['JM','no_weapon'], 1])
            ...
            self.cinematic_frame(screen,'azw1', 3, "C'est vrai. Veuillez m'excuser de mon impolitesse. Je suis Shikisha Musashi.", "Je viens du village de Magome, et je suis récemment devenu un samouraï.","Enchanté. Et vous ?",   kind_info=[['SM','no_weapon'], ['KM','no_weapon'],['JM','no_weapon'], 1])
            ...
            self.cinematic_frame(screen,'azw1', 3, "C'est vrai. Veuillez nous excuser.",   kind_info=[['SM','no_weapon'], ['KT','no_weapon'],['JM','no_weapon'], 1])

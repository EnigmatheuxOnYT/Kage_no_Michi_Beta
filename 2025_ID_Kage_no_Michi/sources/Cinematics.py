    ...
    def cinematic_11 (self, screen, saved="none", choose=1):
        ...
        if saved == 'none':
            if choose == 1:
                ...
                self.cinematic_frame(screen, 'bamboo2', 1,"Quelle naïveté... Pensais-tu vraiment pouvoir me prendre quelque chose", "impunément ?",kind_info=['JM','JM', 'no_weapon', 'right'])
            ...
            if choose == 1:
                ...
                self.cinematic_frame(screen, 'bamboo2', 0,"Un filet de sang jaillit de sa gorge. Son souffle se coupe. Ses jambes", "flanchent.")
                self.cinematic_frame(screen, 'bamboo2', 0,"Le marchand Juzo le regarde avec un sourire narquois, essuyant la lame d’un", "kunai recouvert du sang de Musashi.")
                self.cinematic_frame(screen, 'bamboo2', 2,"Quelle naïveté... Pensais-tu vraiment pouvoir me prendre quelque chose", "impunément ?",kind_info=[['KM', 'no_weapon'], ['JM', 'no_weapon'], 2])
            ...
            if choose == 1:
                ...
                self.cinematic_frame(screen, 'bamboo2', 0,"Un filet de sang jaillit de sa gorge. Son souffle se coupe. Ses jambes", "flanchent.")
                self.cinematic_frame(screen, 'bamboo2', 0,"Le marchand Juzo le regarde avec un sourire narquois, essuyant la lame d’un", "kunai recouvert du sang de Musashi.")
                self.cinematic_frame(screen, 'bamboo2', 2,"Quelle naïveté... Pensais-tu vraiment pouvoir me prendre quelque chose", "impunément ?",kind_info=[['KT', 'no_weapon'], ['JM', 'no_weapon'], 2])
...
if __name__ == '__main__':
    ...
    c = Cinematics()
    output = c.cinematic_15(screen,"none", False, True)
    print(output)
    pygame.quit()

...
def cinematic_10(self, screen, saved="none"):
        if saved == 'none':
            ...
            self.ecran_noir(screen)
            self.cinematic_frame(screen, "azw1", 2, "Tiens ? Un samouraï ?", kind_info=[['SM','no_weapon'], ['JM','no_weapon'], 2, None, None, ['JM']])
            self.cinematic_frame(screen, 'azw1', 2, "Qui êtes-vous ? Que faîtes vous ici ? Expliquez vous !", kind_info=[['SM','no_weapon'], ['JM','no_weapon'], 1])
            self.cinematic_frame(screen, "azw1", 2, "Calmez-vous jeune homme. Je ne souhaite pas vous faire de mal. Avant de me","poser des questions, pourriez-vous au moins vous présenter ?", kind_info=[['SM','no_weapon'], ['JM','no_weapon'], 2, None, None, ['JM']])
            self.cinematic_frame(screen, 'azw1', 2, "Cela n'est pas faux. Veuillez m'excuser de mon impolitesse. Je suis Shikisha", "Musashi. Je viens du village de Magome, et je suis récemment devenu un ","samouraï. Enchanté. Et vous ?", kind_info=[['SM','no_weapon'], ['JM','no_weapon'], 1])
            self.cinematic_frame(screen, 'azw1', 2, "Je suis Juzo Ma, un marchand. Je collecte de nombreux produits pour pouvoir", "les revendre ensuite. Voudriez-vous bien jeter un coup d'œil à mes","marchandises ? ", kind_info=[['SM','no_weapon'], ['JM','no_weapon'], 2])
            self.cinematic_frame(screen, 'azw1', 2, "Très bien. Je suis intéressé par vos offres. Que vendez-vous ?", kind_info=[['SM','no_weapon'], ['JM','no_weapon'], 1])
            self.cinematic_frame(screen, 'azw1', 2, "Je vends de tout. Talismans, potions, nourriture, etc. Auriez-vous une","préférence?", kind_info=[['SM','no_weapon'], ['JM','no_weapon'], 2])
            self.cinematic_frame(screen, 'azw1', 2, "Dans ce cas là, vous devez avoir des armes, n'est-ce pas ?", kind_info=[['SM','no_weapon'], ['JM','no_weapon'], 1])
            self.cinematic_frame(screen, 'azw1', 2, "Absolument! Actuellement, je possède une arme très destructrice. Le “Tengoku", "No Ikari”.(La colère du Paradis)", kind_info=[['SM','no_weapon'], ['JM','no_weapon'], 2])
            self.cinematic_frame(screen, 'azw1', 2, "“Tengoku no Ikari” ? Je n'en ai jamais entendu parler. Pourquoi porte-elle","ce nom ?", kind_info=[['SM','no_weapon'], ['JM','no_weapon'], 1])
            self.cinematic_frame(screen, 'azw1', 2, "La légende raconte que cette lame incarnerait le châtiment de Dieu. On la", "classait comme l'une des 7 épées légendaires. Tous ceux qui sont touchés", "par cette arme périssent en voyant leurs âmes séparées de leurs corps. ", kind_info=[['SM','no_weapon'], ['JM','no_weapon'], 2])
            self.cinematic_frame(screen, 'azw1', 2, "C'est pour cela que je la vends pour 100 pièces d'or. Elle est très rare,","et possède beaucoup de valeur. Alors ? Êtes-vous prêt à l'acheter ?", kind_info=[['SM','no_weapon'], ['JM','no_weapon'], 2])
        elif saved == 'KM':
            self.cinematic_frame(screen,'azw1', 2, "Le moment est enfin arrivé. Je suis enfin devenu un samouraï.",   kind_info=[['SM','no_weapon'], ['KM','no_weapon'], 1])
            self.cinematic_frame(screen,'azw1', 2, "Oui, tu es resté déterminé et tu as réussi à atteindre tes objectifs. Tu es","incroyable grand frère !",   kind_info=[['SM','no_weapon'], ['KM','no_weapon'], 2])
            self.cinematic_frame(screen,'azw1', 2, "Merci Keiko, mais c'est aussi grâce à toi que tu me pousses à continuer ce", "voyage. Ensemble, la famille Musashi ne périra jamais. ",   kind_info=[['SM','no_weapon'], ['KM','no_weapon'], 1])
            self.cinematic_frame(screen,'azw1', 2, "Très bien dit Shikisha. Ne restons pas les bras croisés et poursuivons ce", "voyage !",   kind_info=[['SM','no_weapon'], ['KM','no_weapon'], 2])
            self.cinematic_frame(screen,'azw1', 2, "En effet. Allons-y Keiko. Ne perdons pas de temps !",   kind_info=[['SM','no_weapon'], ['KM','no_weapon'], 1])
            self.ecran_noir(screen)
            self.cinematic_frame(screen,'azw1', 2, "Tiens, Shikisha. On dirait qu'il y a une caravane au milieu de la route.",   kind_info=[['SM','no_weapon'], ['KM','no_weapon'], 2])
            self.cinematic_frame(screen,'azw1', 2, "C'est vrai. Se pourrait-il qu'il y ait un marchand ?",   kind_info=[['SM','no_weapon'], ['KM','no_weapon'], 1])
            self.cinematic_frame(screen, "azw1", 0, "(Les buissons bougent derrière la caravane)")
            self.cinematic_frame(screen,'azw1', 2, "Hm? (Un ennemi ?). Montrez vous ! Je sais que vous vous trouvez à l'intérieur", "de cette caravane.",   kind_info=[['SM','no_weapon'], ['KM','no_weapon'], 1])
            self.cinematic_frame(screen, "azw1", 0, "(Une figure apparaît)")
            self.cinematic_frame(screen, "azw1", 3, "Tiens ? Un samouraï ?", kind_info=[['SM','no_weapon'], ['KM','no_weapon'],['JM','no_weapon'], 3, None, ['JM']])
            self.cinematic_frame(screen,'azw1', 3, "Qui êtes-vous ? Que faîtes vous ici ? Expliquez vous !",   kind_info=[['SM','no_weapon'], ['KM','no_weapon'],['JM','no_weapon'], 1])
            self.cinematic_frame(screen, "azw1", 3, "Calmez-vous jeune homme. Je ne souhaite pas vous faire de mal. Avant", "de me poser des questions, pourriez-vous au moins vous présenter ?", kind_info=[['SM','no_weapon'], ['KM','no_weapon'],['JM','no_weapon'], 3, None, ['JM']])
            self.cinematic_frame(screen,'azw1', 3, "Cela n'est pas faux. Veuillez excuser mon impolitesse. Je suis Shikisha","Musashi. Je viens du village de Magome, et je suis récemment devenu un", "samouraï.",   kind_info=[['SM','no_weapon'], ['KM','no_weapon'],['JM','no_weapon'], 1])
            self.cinematic_frame(screen,'azw1', 3, "Je suis Keiko Musashi, sa sœur. Ravi de vous rencontrer. Et vous ?",   kind_info=[['SM','no_weapon'], ['KM','no_weapon'],['JM','no_weapon'], 2])
            self.cinematic_frame(screen, "azw1", 3, "Je suis Juzo Ma, un marchand. Je collecte de nombreux produits pour pouvoir", "les revendre ensuite. Voudriez-vous bien jeter un coup d'œil à mes", "marchandises ?", kind_info=[['SM','no_weapon'], ['KM','no_weapon'],['JM','no_weapon'], 3])
            self.cinematic_frame(screen,'azw1', 3, "Shikisha, je pense qu'il pourrait y avoir des armes ou des armures pour", "t'équiper. Voyons voir de plus près ce qu'il pourrait vendre.",   kind_info=[['SM','no_weapon'], ['KM','no_weapon'],['JM','no_weapon'], 2])
            self.cinematic_frame(screen,'azw1', 3, "Pas bête chère sœur. Marchand Juzo, que vendez-vous?",   kind_info=[['SM','no_weapon'], ['KM','no_weapon'],['JM','no_weapon'], 1])
            self.cinematic_frame(screen, "azw1", 3, "Je vends de tout. Talismans, potions, nourriture, etc. Auriez-vous une", "préférence?", kind_info=[['SM','no_weapon'], ['KM','no_weapon'],['JM','no_weapon'], 3])
            self.cinematic_frame(screen,'azw1', 3, "Dans ce cas là, vous devez avoir des armes, n'est-ce pas ?",   kind_info=[['SM','no_weapon'], ['KM','no_weapon'],['JM','no_weapon'], 1])
            self.cinematic_frame(screen, "azw1", 3, "Absolument ! Actuellement, je possède une arme très destructrice. Le", "“Tengoku No Ikari”. (La colère du Paradis)", kind_info=[['SM','no_weapon'], ['KM','no_weapon'],['JM','no_weapon'], 3])
            self.cinematic_frame(screen,'azw1', 3, "“Tengoku no Ikari”? Je n'en ai jamais entendu parler. Pourquoi porte-"," elle ce nom ?",   kind_info=[['SM','no_weapon'], ['KM','no_weapon'],['JM','no_weapon'], 1])
            self.cinematic_frame(screen, "azw1", 3, "La légende raconte que cette lame incarnerait le châtiment de Dieu. On la", "classe comme l'une des 7 épées légendaires. Tous ceux qui sont touchés", "par cette arme périssent en voyant leurs âmes séparées de leurs corps.  ", kind_info=[['SM','no_weapon'], ['KM','no_weapon'],['JM','no_weapon'], 3])
            self.cinematic_frame(screen, "azw1", 3, "C'est pour cela que je la vends pour 100 pièces d’or. Elle est très rare, et", "possède beaucoup de valeur. Alors ? Êtes-vous prêt à l'acheter ?", kind_info=[['SM','no_weapon'], ['KM','no_weapon'],['JM','no_weapon'], 3])


        elif saved == 'KT':
            self.cinematic_frame(screen,'azw1', 2, "Le moment est enfin venu Takeshi. Nous sommes devenus des samouraïs.",   kind_info=[['SM','no_weapon'], ['KT','no_weapon'], 1])
            self.cinematic_frame(screen,'azw1', 2, "Après 1 mois d'entraînement acharné, nous allons enfin pouvoir venger Magome.", "Cela ne sera pas facile Musashi. Il faudra continuer à travailler dur","si on veut battre le clan Takahiro.",  kind_info=[['SM','no_weapon'], ['KT','no_weapon'], 2])
            self.cinematic_frame(screen,'azw1', 2, "En effet. Il ne faut surtout pas s'arrêter à notre niveau actuel. On peut", "toujours aller plus loin. Pour l'instant, le but, c'est d'atteindre le", "village d'Aizuwakamatsu pour pouvoir bien s'équiper lors du combat final.",   kind_info=[['SM','no_weapon'], ['KT','no_weapon'], 1])
            self.cinematic_frame(screen,'azw1', 2, "Utilisons ces pièces à bon escient. Tu es prêt Musashi ? Traversons cette", "forêt !",   kind_info=[['SM','no_weapon'], ['KT','no_weapon'], 2])
            self.cinematic_frame(screen,'azw1', 2, "On y va Takeshi ! Ensemble, nous sommes invincibles !",   kind_info=[['SM','no_weapon'], ['KT','no_weapon'], 1])
            self.ecran_noir(screen)
            self.cinematic_frame(screen,'azw1', 2, "Sois vigilant Musashi, un ennemi semble être caché dans les parages.",   kind_info=[['SM','no_weapon'], ['KT','no_weapon'], 2])
            self.cinematic_frame(screen,'azw1', 2, "Hm? (Un ennemi ?). Cela semble bien être le cas. Il se cache dans cette", "caravane.",   kind_info=[['SM','no_weapon'], ['KT','no_weapon'], 1])
            self.cinematic_frame(screen,'azw1', 2, "Je m'en occupe. Montrez vous ! Je sais que vous vous trouvez à l'intérieur", "de cette caravane.",   kind_info=[['SM','no_weapon'], ['KT','no_weapon'], 2])
            self.cinematic_frame(screen, "azw1", 3, "Tiens ? Des voyageurs ? Plus spécifiquement des samouraïs ?", kind_info=[['SM','no_weapon'], ['KT','no_weapon'],['JM','no_weapon'], 3, None, ['JM']])
            self.cinematic_frame(screen,'azw1', 3, "Qui êtes-vous ? Que faîtes vous ici ? Expliquez vous !",   kind_info=[['SM','no_weapon'], ['KT','no_weapon'],['JM','no_weapon'], 1])
            self.cinematic_frame(screen, "azw1", 3, "Calmez-vous jeunes hommes. Je ne souhaite pas vous faire de mal. Avant de", "me poser des questions, pourriez-vous au moins vous présenter ?", kind_info=[['SM','no_weapon'], ['KT','no_weapon'],['JM','no_weapon'], 3, None, ['JM']])
            self.cinematic_frame(screen,'azw1', 3, "Cela n'est pas faux. Veuillez nous excuser.",   kind_info=[['SM','no_weapon'], ['KT','no_weapon'],['JM','no_weapon'], 1])
            self.cinematic_frame(screen,'azw1', 3, "Je m'excuse aussi. Je suis Kurosawa Takeshi, un samouraï. ",   kind_info=[['SM','no_weapon'], ['KT','no_weapon'],['JM','no_weapon'], 2])
            self.cinematic_frame(screen,'azw1', 3, "Je suis Shikisha Musashi. Nous provenons tous les deux du village de Magome", "et nous sommes récemment devenus des samouraïs. ",   kind_info=[['SM','no_weapon'], ['KT','no_weapon'],['JM','no_weapon'], 1])
            self.cinematic_frame(screen,'azw1', 3, "Enchanté de faire votre connaissance. Et vous ?",   kind_info=[['SM','no_weapon'], ['KT','no_weapon'],['JM','no_weapon'], 2])
            self.cinematic_frame(screen, "azw1", 3, "Je suis Juzo Ma, un marchand. Je collecte de nombreux produits pour pouvoir", "les revendre ensuite. Voudriez-vous bien jeter un coup d'œil à mes", "marchandises ?", kind_info=[['SM','no_weapon'], ['KT','no_weapon'],['JM','no_weapon'], 3])
            self.cinematic_frame(screen,'azw1', 3, "Un marchand qui vend divers types d'objets ? On a peut-être la possibilité de","s'équiper au préalable.",   kind_info=[['SM','no_weapon'], ['KT','no_weapon'],['JM','no_weapon'], 2])
            self.cinematic_frame(screen,'azw1', 3, "Je suis du même avis. Très bien. Que vendez-vous?",   kind_info=[['SM','no_weapon'], ['KT','no_weapon'],['JM','no_weapon'], 1])
            self.cinematic_frame(screen, "azw1", 3, "Je vends de tout. Talismans, potions, nourriture, etc. Auriez-vous une", "préférence?", kind_info=[['SM','no_weapon'], ['KT','no_weapon'],['JM','no_weapon'], 3])
            self.cinematic_frame(screen,'azw1', 3, "Dans ce cas là, vous devez avoir des armes, n'est-ce pas ?",   kind_info=[['SM','no_weapon'], ['KT','no_weapon'],['JM','no_weapon'], 1])
            self.cinematic_frame(screen, "azw1", 3, "Absolument ! Actuellement, je possède une arme très destructrice. Le", "“Tengoku No Ikari”. (La colère du Paradis)", kind_info=[['SM','no_weapon'], ['KT','no_weapon'],['JM','no_weapon'], 3])
            self.cinematic_frame(screen,'azw1', 3, "“Tengoku no Ikari”? Je n'en ai jamais entendu parler. Pourquoi porte-"," elle ce nom ?",   kind_info=[['SM','no_weapon'], ['KT','no_weapon'],['JM','no_weapon'], 1])
    ...
    def cinematic_11 (self, screen, saved="none", choose=1):
        if saved == 'none':
            if choose == 1:
                self.cinematic_frame(screen, 'azw1', 2, "Marché conclu. J'achète votre arme.", kind_info=[['SM','no_weapon'], ['JM','no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 2, "Ravi de faire affaire avec vous.", kind_info=[['SM','no_weapon'], ['JM','no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 2, "Le“Tengoku no Ikari”... J'en prendrai bien soin.", kind_info=[['SM','no_weapon'], ['JM','no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 2, "Faîtes en bon usage. Vous ne le regretterez pas.", kind_info=[['SM','no_weapon'], ['JM','no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 2, "Je vous en remercie ! Faîtes attention à vous !", kind_info=[['SM','no_weapon'], ['JM','no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 2, "Merci jeune homme ! N'hésite pas à revenir me voir !", kind_info=[['SM','no_weapon'], ['JM','no_weapon'], 2])
                ...
                self.cinematic_frame(screen, 'azw1', 2, "Je vous remercie de votre offre, mais je vais devoir refuser.",kind_info=[['SM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 2, "Ah bon ? Dommage. Peut-être une prochaine fois.", kind_info=[['SM', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 2, "En effet, peut-être une prochaine fois.", kind_info=[['SM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 2, "Si on se retrouve, n'hésitez pas à me faire part de ce que vous recherchez.", kind_info=[['SM', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 2, "Compris ! On se retrouvera lorsque le moment viendra.",kind_info=[['SM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 2, "Sur ce, à la prochaine jeune homme ! ",kind_info=[['SM', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 2, "A la prochaine marchand Juzo ! Faîtes très attention lors de votre voyage ! ",kind_info=[['SM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, "azw1", 0,"Musashi poursuit son voyage pour venger son village natal. Arrivera-t-il", "à atteindre sa destination ? A suivre dans le prochain épisode.")
            elif choose == 3:
                self.cinematic_frame(screen, 'azw1', 2, "J'aimerais bien vous prendre cette arme, en échange d'un service que vous", "pourriez me proposer.",kind_info=[['SM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 2, "Un service tu dis ? Je vois, tu me dois donc un service si jamais tu", "prends cette lame.", kind_info=[['SM', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 2, "En effet. Je dois venger mon village natal qui a été détruit par le clan", "Takahiro. C'est un cas assez urgent pour moi. Je vous en fais la promesse.",kind_info=[['SM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 2, "Hmm... D'accord, j'accepte ton offre. Actuellement, je n'ai pas de service", "à te demander pour mon travail mais je t'en ferai part lorsqu’on se", "retrouvera.", kind_info=[['SM', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 2, "Voici le“Tengoku no Ikari”. Fais-en bon usage et fais très attention,", "notamment aux ennemis que tu rencontreras. ", kind_info=[['SM', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 2, "C'est noté. Je resterai prudent lors de mon voyage. Encore une fois, je", "vous remercie de votre bienveillance.",kind_info=[['SM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 2, "Aucun problème, on peut dire que c'est un cadeau en premier lieu. N'oublie", "pas ta promesse et on se reverra aussitôt! Bon courage pour ta quête Musashi !", kind_info=[['SM', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 2, "Entendu ! Bon courage à vous aussi marchand Juzo !",kind_info=[['SM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, "azw1", 0,"Musashi obtient l'une des 7 épées légendaires: Le“Tengoku no Ikari”et", "poursuit son voyage pour venger son village natal. Sera-t-il conforme", "aux attentes de notre samouraï ? A suivre dans le prochain épisode.")
            elif choose == 4:
                self.cinematic_frame(screen, 'azw1', 2, "Pardonnez moi, mais je n'aurais pas le choix de vous le prendre de force. Je","ne vais pas dépenser mon argent sur une arme qui pourrait être une arnaque.",kind_info=[['SM', 'no_weapon'], ['JM', 'no_weapon'], 1])
            ...
            if choose == 1:
                ...
                self.cinematic_frame(screen, 'azw1', 3, "Ravi de faire affaire avec vous.",kind_info=[['SM', 'no_weapon'],['KM', 'no_weapon'], ['JM', 'no_weapon'], 3])
                self.cinematic_frame(screen, 'azw1', 3, "Super grand frère ! Te voilà bien équipé en cours de route !",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 3, "Le“Tengoku no Ikari”... J'en prendrai bien soin.",kind_info=[['SM', 'no_weapon'],['KM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3, "Faîtes en bon usage. Vous ne le regretterez pas.",kind_info=[['SM', 'no_weapon'],['KM', 'no_weapon'], ['JM', 'no_weapon'], 3])
                self.cinematic_frame(screen, 'azw1', 3, "Je vous en remercie ! Faîtes attention à vous !",kind_info=[['SM', 'no_weapon'],['KM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3, "En effet, merci à vous ! Faîtes attention à vous !",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 3,"Merci jeune homme et sa sœur ! N'hésitez pas à revenir me voir !",kind_info=[['SM', 'no_weapon'],['KM', 'no_weapon'], ['JM', 'no_weapon'], 3])
                self.cinematic_frame(screen, "azw1", 0,"Musashi obtient l'une des 7 épées légendaires : Le“Tengoku no Ikari”et","poursuit son voyage pour venger son village natal. Sera-t-elle conforme","aux attentes de notre samouraï ? A suivre dans le prochain épisode.")
            elif choose == 2:
                self.cinematic_frame(screen, 'azw1', 3, "Je vous remercie de votre offre, mais je vais devoir refuser.",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3,"Tu ne comptes pas acheter cette arme ? Cela pourrait-être utile.",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 3, "Ah bon ? Dommage. Peut-être une prochaine fois.",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 3])
                self.cinematic_frame(screen, 'azw1', 3, "En effet, peut-être une prochaine fois.",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3,"Si on se retrouve, n'hésitez pas à me faire part de ce que vous recherchez.",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 3])
                self.cinematic_frame(screen, 'azw1', 3, "Compris ! On se retrouvera lorsque le moment viendra.",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3, "Sur ce, à la prochaine jeune homme et jeune fille!",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 3])
                self.cinematic_frame(screen, 'azw1', 3,"A la prochaine marchand Juzo! Faîtes très attention lors de votre voyage !",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3, "A la prochaine !",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, "azw1", 0, "Musashi poursuit son voyage pour venger son village natal. Arrivera-t-il à","atteindre sa destination ? A suivre dans le prochain épisode.")
            elif choose == 3:
                self.cinematic_frame(screen, 'azw1', 3,"J'aimerais bien vous prendre cette arme, en échange d'un service que vous","pourriez me proposer.",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3,"Un service tu dis ? Je vois, tu me dois donc un service si jamais tu prends","cette lame.",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 3])
                self.cinematic_frame(screen, 'azw1', 3,"En effet. Je dois venger mon village natal qui a été détruit par le clan","Takahiro.",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3,"C'est un cas assez urgent pour moi. Je vous en fais la promesse.",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3,"Hmm... D'accord, j'accepte ton offre. Actuellement, je n'ai pas de service","à te demander pour mon travail mais je t'en ferai part lorsqu'on se","retrouvera.",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 3])
                self.cinematic_frame(screen, 'azw1', 3,"Voici le“Tengoku no Ikari”. Fais-en bon usage et fais très attention,","notamment aux ennemis que tu rencontreras.",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 3])
                self.cinematic_frame(screen, 'azw1', 3,"Il faudra que tu sois plus vigilent Shikisha si jamais tu comptes battre","le clan Takahiro.",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 3,"C'est noté. Je resterai prudent lors de mon voyage. Encore une fois, je vous","remercie de votre bienveillance.",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3,"Aucun problème, on peut dire que c'est un cadeau en premier lieu. N'oublie","pas ta promesse et on se reverra aussitôt !",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 3])
                self.cinematic_frame(screen, 'azw1', 3,"Bon courage pour ta quête Musashi ! Ainsi que toi Keiko !",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 3])
                self.cinematic_frame(screen, 'azw1', 3,"Entendu ! Bon courage à vous aussi marchand Juzo !",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, "azw1", 0,"Musashi obtient l’une des 7 épées légendaires: Le“Tengoku no Ikari”et","poursuit son voyage pour venger son village natal. Sera-t-elle conforme","aux attentes de notre samouraï ? A suivre dans le prochain épisode.")
            elif choose == 4:
                self.cinematic_frame(screen, 'azw1', 3,"Pardonnez moi, mais je n'ai pas le choix de vous le prendre de force.",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3,"Eh ? ! Mais pourquoi ferais-tu cela grand frère ?",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 3,"Je ne vais pas dépenser mon argent sur une arme qui pourrait être une arnaque.",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3,"Mais dans ce cas là refuse alors ? Cela ne te correspond pas !",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 3,"Es-tu si sûr de ça mon garçon? Je te déconseille fortement de me sous-estimer.",kind_info=[['SM', 'no_weapon'], ['KM', 'no_weapon'], ['JM', 'no_weapon'], 3])
            ...
            if choose == 1:
                ...
                self.cinematic_frame(screen, 'azw1', 3, "Génial Musashi ! Tu vas devenir extrêmement puissant !",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 3, "Ravi de faire affaire avec vous.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 3])
                self.cinematic_frame(screen, 'azw1', 3, "Le “Tengoku no Ikari”... J'en prendrai bien soin.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3, "Faîtes en bon usage. Vous ne le regretterez pas.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 3])
                self.cinematic_frame(screen, 'azw1', 3, "Je vous en remercie ! Faîtes attention à vous !",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3, "Merci de votre offre ! A la prochaine !",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 3, "Merci à vous ! N'hésite pas à revenir me voir !",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 3])
                self.cinematic_frame(screen, 'azw1', 0,"Musashi obtient l’une des 7 épées légendaires: Le“Tengoku no Ikari”et","poursuit son voyage pour venger son village natal. Sera-t-elle conforme","aux attentes de notre samouraï? A suivre dans le prochain épisode.")
            elif choose == 2:
                self.cinematic_frame(screen, 'azw1', 3, "Je vous remercie de votre offre, mais je vais devoir refuser.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3,"C'était une occasion gâchée. Cela n'est pas grave, on pourra acheter d'autres","armes dans le village.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 3, "Ah bon ? Dommage. Peut-être une prochaine fois.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 3])
                self.cinematic_frame(screen, 'azw1', 3, "En effet, peut-être une prochaine fois.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3,"Si on se retrouve, n'hésitez pas à me faire part de ce que vous recherchez.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 3])
                self.cinematic_frame(screen, 'azw1', 3, "Compris ! On se retrouvera lorsque le moment viendra.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3, "Sur ce, à la prochaine jeune homme !",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 3,"A la prochaine marchand Juzo! Faîtes très attention lors de votre voyage !",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 0,"Musashi poursuit son voyage pour venger son village natal. Arrivera-t-il à","atteindre sa destination? A suivre dans le prochain épisode.")
            elif choose == 3:
                self.cinematic_frame(screen, 'azw1', 3,"J'aimerais bien vous prendre cette arme, en échange d'un service que vous","pourriez me proposer.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3,"Un service tu dis ? Je vois, tu me dois donc un service si jamais tu prends","cette lame.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 3,"En effet. Je dois venger mon village natal qui a été détruit par le clan","Takahiro.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3,"C'est un cas assez urgent pour moi. Je vous en fais la promesse.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3,"Hmm...D'accord, j'accepte ton offre. Actuellement, je n'ai pas de service","à te demander pour mon travail mais je t'en ferai part lorsqu'on se", "retrouvera.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 3,"Voici le“Tengoku no Ikari”. Fais-en bon usage et fais très attention,","notamment aux ennemis que tu rencontreras.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3, "Continuons de rester sur nos gardes. On ne sait jamais.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3,"C'est noté. Je resterai prudent lors de mon voyage. Encore une fois, je vous","remercie de votre bienveillance.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3,"Aucun problème, on peut dire que c’est un cadeau en premier lieu. N'oublie","pas ta promesse et on se reverra aussitôt !",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3, "Bon courage pour ta quête Musashi !",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 3, "Entendu ! Bon courage à vous aussi marchand Juzo !",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 0,"Musashi poursuit son voyage pour venger son village natal. Arrivera-t-il","à atteindre sa destination? A suivre dans le prochain épisode.")
            elif choose ==4:
                self.cinematic_frame(screen, 'azw1', 3,"Pardonnez moi, mais je n'ai pas le choix de vous le prendre de force.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3,"Que fais-tu Musashi !?",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 2])
                self.cinematic_frame(screen, 'azw1', 3,"Je ne vais pas dépenser mon argent sur une arme qui pourrait être une arnaque.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 1])
                self.cinematic_frame(screen, 'azw1', 3,"Es-tu si sûr de ça mon garçon? Je te déconseille fortement de me sous-estimer.",kind_info=[['SM', 'no_weapon'], ['KT', 'no_weapon'], ['JM', 'no_weapon'], 3])
